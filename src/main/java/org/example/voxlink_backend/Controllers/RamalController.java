...
public class RamalController {
    ...
    @PostMapping("/desativar/{ramalId}")
    public ResponseEntity<String> desativarRamal(@PathVariable Long ramalId, @RequestHeader("Authorization") String authHeader) {
        String token = authHeader.replace("Bearer ", "");
        String codigoLogin = jwtService.extrairCodigoLogin(token);
        ...
        String resultado = ramalService.desativarRamal(ramalId);
        return ResponseEntity.ok(resultado);
    }
    ...
    public ResponseEntity<String> desassociarUsuarioDoRamal(
        ...
        String resultado = ramalService.desassociarUsuarioDoRamal(codigoLogin);
        return ResponseEntity.ok(resultado);
    }
